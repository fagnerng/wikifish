...
public class FishDetailsActivity extends Activity {
	...
	private void setPicture() {
		...
		iv_fish.setOnClickListener(new OnClickListener() {
			...
			public void onClick(final View v) {
				DialogImageZoom mDialog = new DialogImageZoom(
						FishDetailsActivity.this, iv_fish.getDrawable());
				mDialog.show();
		...
		if (!mFish.urlPicture.isEmpty()) {
			...
			final ImageHandlingTask iHT_downloader = new ImageHandlingTask(
					iv_fish, this);
			iHT_downloader.execute(mFish.urlPicture);
		}
	}
	...
	private void setComments() {
		...
		CommentHelper.loadComments(MainActivity.session.token,
				new CommentHelper.Callback() {
					...
					public void call(List<Comment> comments) {
						...
						adapter = new CommentListAdapter(
								FishDetailsActivity.this, mFish.comments);
						...
						bt_add_comment
								.setOnClickListener(new OnClickListener() {
									...
									@Override
									public void onClick(final View v) {
										final DialogComment dialogComment = new DialogComment(
												FishDetailsActivity.this);
										dialogComment._id = mFish.id;
										dialogComment.show();
