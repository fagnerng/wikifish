...
public class LoginFragment extends AuthFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.setupSocialLogin(view, R.id.google_button, "google");
        super.setupSocialLogin(view, R.id.github_button, "github");
	...
	public void onLoginCompleted(Boolean authenticated, Exception exception) {
		...
		Toast.makeText(getActivity().getApplicationContext(), "Authenticated: "+ authenticated, Toast.LENGTH_SHORT).show();
		if (exception != null) {
